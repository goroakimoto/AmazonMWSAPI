...
class Orders extends Sections
{

    protected $feedType = "";
    protected $feedContent = "";
    protected $versionDate = "2013-09-01";
    private $overviewUrl = "http://docs.developer.amazonservices.com/en_US/orders-2013-09-01/Orders_Overview.html";
    private $libraryUpdateUrl = "http://docs.developer.amazonservices.com/en_US/orders-2013-09-01/Orders_ClientLibraries.html";
    protected $dataTypes = [
        "Address" => [
            "Name" => [
                "required"
