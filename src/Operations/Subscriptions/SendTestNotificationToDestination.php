...
class SendTestNotificationToDestination extends Subscriptions
{
    ...
    private $apiUrl = "http://docs.developer.amazonservices.com/en_US/subscriptions/Subscriptions_SendTestNotificationToDestination.html";
